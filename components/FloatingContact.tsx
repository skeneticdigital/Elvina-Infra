...
import { MessageCircle } from 'lucide-react'; // Using MessageCircle as WhatsApp placeholder since lucide doesn't have exact WhatsApp icon by default, but it's close enough when colored green.
